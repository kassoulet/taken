...
import RegistryStatusGrid from '../src/components/RegistryStatusGrid/RegistryStatusGrid';
...
describe('RegistryStatusGrid Component', () => {
  const mockRegistryStatuses = [
    ...
    {
      registry: { id: 'pypi', name: 'PyPI', apiEndpoint: 'https://pypi.org/pypi/' },
      packageName: 'test-package',
  ...
  it('shows loading state', () => {
    render(<RegistryStatusGrid packageName="test-package" registryStatuses={[]} loading={true} />);
